...
{
    public class UtilEncriptDecript
    {
        #region ENCRIPTACIÓN CON EL METODO AES
        public string Encriptar_AES(string clearText)
        {
        ...
        #endregion ENCRIPTACIÓN CON EL METODO AES
    }
}
